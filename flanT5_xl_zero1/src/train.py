...
class PyTorchProfilerCallback(TrainerCallback):
    ...
    def _trace_handler(self, prof):
        ...
        #print("\n" + "="*80)
        #print("PROFILER SUMMARY - MEMORY USAGE")
        #print("="*80)
        #print(prof.key_averages().table(
...
def main():
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        save_strategy="no", #"epoch", #  use this if want to save checkpoints on steps "steps", #it uses lot of memory in my case 49 gb
        ...
        deepspeed=config['deepspeed']['deepspeed_zero1_config'] if config['deepspeed']['enabled'] else None,
    ...
    # Get resume checkpoint if specified
